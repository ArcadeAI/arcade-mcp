...
import arcade_sdfg
from arcade_sdfg.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_sdfg)


@tool_eval()
def sdfg_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="sdfg Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to sdfg tools. "
