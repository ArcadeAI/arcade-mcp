...
async def get_users(
    ...
    include_guests: Annotated[
        bool,
        "Whether to include guest users in results. Defaults to False (team members only)."
    ] = False,
    active_only: Annotated[
        bool,
        "Whether to only return active users. Defaults to True (exclude inactive users)."
    ] = True,
    limit: Annotated[
        int,
        "Maximum number of users to return. Min 1, max 100. Defaults to 50."
    ] = 50,
