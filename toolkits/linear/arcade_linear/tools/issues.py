...
async def search_issues(
    ...
    team: Annotated[
        str | None, "Team name or ID to filter issues by. Defaults to None (all teams)."
    ] = None,
    status: Annotated[
        str | None,
    ...
    project: Annotated[
        str | None, "Project name or ID to filter issues by. Defaults to None (all projects)."
    ] = None,
...
async def create_issue(
    ...
    priority: Annotated[
        str | None, "Priority level: 'none', 'low', 'medium', 'high', 'urgent'. Defaults to None."
    ] = None,
    status: Annotated[
        str | None,
    ...
    project: Annotated[
        str | None, "Project name or ID to associate this issue with. Defaults to None."
    ] = None,
...
async def add_comment_to_issue(
    context: ToolContext,
    issue_id: Annotated[
        str, "The Linear issue ID or identifier (e.g. 'FE-123', 'API-456') to add a comment to."
    ],
