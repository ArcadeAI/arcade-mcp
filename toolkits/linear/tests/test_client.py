...
class TestLinearClient:
    ...
    async def test_get_viewer(self, mock_execute_query):
        ...
        mock_execute_query.return_value = {
            "data": {"viewer": {"id": "user_1", "name": "John Doe", "email": "john@company.com"}}
        }
    ...
    async def test_create_issue(self, mock_execute_mutation):
        ...
        mock_execute_mutation.return_value = {
            "data": {
                "issueCreate": {
                    "success": True,
                    "issue": {"id": "issue_1", "identifier": "FE-124", "title": "New issue"},
                }
            }
        }
    ...
    async def test_update_issue(self, mock_execute_mutation):
        ...
        mock_execute_mutation.return_value = {
            "data": {
                "issueUpdate": {
                    "success": True,
                    "issue": {"id": "issue_1", "identifier": "FE-123", "title": "Updated title"},
                }
            }
        }
    ...
    async def test_get_user_by_email(self, mock_execute_query):
        ...
        mock_execute_query.return_value = {
            "data": {
                "users": {
                    "nodes": [{"id": "user_1", "name": "John Doe", "email": "john@company.com"}]
                }
            }
        }
