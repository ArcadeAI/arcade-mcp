...
def mock_service():
    with patch(
        "arcade_google_docs.tools.docs." + build_docs_service.__name__
...
async def test_insert_text_at_end_of_document_success(mock_context, mock_service):
    ...
    with patch(
        "arcade_google_docs.tools.docs.get_document_by_id",
...
async def test_create_document_from_text_success(mock_context, mock_service):
    with patch(
        "arcade_google_docs.tools.docs." + create_blank_document.__name__
