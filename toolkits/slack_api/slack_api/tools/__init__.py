...
This module was auto-generated by Agent Moar by transpiling the API Wrapper Tool
definitions into Python code. Any changes to this module will be overwritten by
the transpiler.

In case any changes are necessary, edit the JSON files in the ../wrapper_tools
directory, then run `moar export-tools {path_to_tools_dir}` to regenerate this
module.
"""
...
async def add_slack_emoji_alias(
    ...
    emoji_alias_name: Annotated[
        str,
        "The new alias for the specified emoji. Whitespace or colons will be automatically trimmed.",
    ],
    target_emoji_name: Annotated[
        str,
        "The name of the existing emoji to which the new alias is being added. Remove any surrounding whitespace or colons.",
    ],
...
async def list_slack_enterprise_emojis(
    ...
    pagination_cursor: Annotated[
        str | None,
        "Cursor for fetching the next page of emojis. Use 'next_cursor' from the previous response.",
    ] = None,
    ...
    This tool uses the Slack Admin API to fetch a list of emojis available in a Slack Enterprise organization. It requires the appropriate OAuth scope to access team information."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def rename_slack_emoji(
    ...
    current_emoji_name: Annotated[
        str,
        "The current name of the emoji to be renamed. Colons (:myemoji:) around the value are optional.",
    ],
    ...
    Use this tool to rename a custom emoji within a Slack Enterprise organization. It requires appropriate OAuth scope for team operations."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_approved_workspace_invite_requests(
    ...
    workspace_id: Annotated[
        str | None,
        "ID for the Slack workspace where the invite requests were made. Required if the Enterprise org has more than one workspace.",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
    ...
    This tool retrieves a list of all approved invite requests for a Slack workspace. It should be called when there is a need to review or manage approved invitations. The response will include details of each invitation request."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_denied_slack_invite_requests(
    ...
    workspace_team_id: Annotated[
        str | None,
        "ID of the workspace where the invite requests were made. Required if the Enterprise org has multiple workspaces.",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
        "The cursor value from the previous API response to fetch the next set of results. Use this for pagination.",
    ] = None,
    result_limit: Annotated[
        int | None,
        "Specify the number of denied invite request results to return, between 1 and 1000 inclusive. (default: '100')",
    ] = None,
) -> Annotated[
    ...
    This tool retrieves a list of all denied workspace invite requests on Slack. It should be called when there is a need to review or analyze denied invitations to a Slack workspace."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_pending_workspace_invites(
    ...
    workspace_id: Annotated[
        str | None,
        "The ID of the workspace to list pending invite requests from. Required for multi-workspace enterprises.",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
        "The cursor value for fetching the next set of invite requests. Use the `next_cursor` from the previous response if available.",
    ] = None,
    result_limit: Annotated[
        int | None,
        "The number of invite requests to return per call, must be between 1 and 1000. (default: '100')",
    ] = None,
    ...
    Use this tool to list all pending workspace invite requests in a Slack workspace. This can be useful for administrators managing team invitations. Requires 'admin.invites:read' OAuth scope."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_teams_in_enterprise(
    ...
    maximum_items_to_return: Annotated[
        int | None,
        "Specify the maximum number of teams to retrieve. Must be a positive integer, up to 1000. (default: '100')",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
        "Use this to retrieve the next page of results by setting it to the `next_cursor` from the previous response.",
    ] = None,
    ...
    This tool retrieves a list of all teams within an Enterprise organization on Slack, utilizing the admin.teams.list endpoint. It should be called when information about the teams in an Enterprise organization is needed."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_slack_workspace_owners(
    ...
    maximum_items_to_return: Annotated[
        int | None,
        "Specifies the maximum number of owners to return, ranging from 1 to 1000. (default: '100')",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
        "The cursor from the previous response used to fetch the next page of owners. Leave empty for the first page.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'admin.teams.owners.list'."]:
    """Retrieve all owners in a Slack workspace.

    This tool retrieves a list of all the owners in a specified Slack workspace, using the admin.teams.owners.list API endpoint. It is useful for managing or viewing the user roles within a Slack workspace."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def fetch_workspace_settings_info(
    ...
    slack_team_id: Annotated[
        str,
        "The unique identifier of the Slack workspace (team) for which to fetch the settings information.",
    ],
...
async def set_workspace_description(
    ...
    This tool updates the description of a specified workspace in Slack. It requires admin permissions with the 'admin.teams:write' scope. It should be called when there is a need to change or set a new description for a Slack team."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def set_slack_workspace_name(
    ...
    Use this tool to update the name of a specified Slack workspace. This tool should be called when there's a need to change the workspace name. It requires appropriate permissions."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_channels_for_usergroup(
    ...
    usergroup_id: Annotated[
        str,
        "The ID of the IDP group to list channels for. It identifies which organizational group to retrieve the default channels from.",
    ],
    ...
    Fetches a list of channels associated with a specified organizational IDP group in Slack. This tool is useful for admins managing user groups and their related channels."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_workspace_users(
    ...
    workspace_team_id: Annotated[
        str | None,
        "The ID of the Slack workspace (e.g., T1234) to filter users from. Only users from this workspace will be listed.",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
        "Use this to navigate through paginated results by setting it to the `next_cursor` from a previous response.",
    ] = None,
    ...
    return_only_active_users: Annotated[
        bool | None,
        "Return only active users if true; return only deactivated users if false. Default is true.",
    ] = None,
    include_deactivated_user_workspaces: Annotated[
        bool | None,
        "Include workspaces for users even if they are deactivated. Only applies with org token and no team_id. Default is false.",
    ] = None,
    return_only_guest_users: Annotated[
        bool | None,
        "If true, returns only guests and their expiration dates that belong to the specified team_id.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'admin.users.list'."]:
    """Retrieve a list of users from a Slack workspace.

    Use this tool to get a list of users in a specific Slack workspace. It's helpful for administrators who need to manage or view user information within the workspace."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def check_api_calling_code(
    ...
    simulate_error_response: Annotated[
        str | None,
        "Specify an error code to simulate an error response for testing API calls. Useful for testing error handling.",
    ] = None,
...
async def revoke_slack_token(
    ...
    trigger_testing_mode: Annotated[
        bool | None,
        "Set to true to trigger testing mode where the token will not be revoked. Useful for testing.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'auth.revoke'."]:
    """Revoke a Slack authentication token.

    This tool is used to revoke a Slack authentication token via a GET request to the Slack API endpoint. It should be called when it is necessary to invalidate a token to ensure it is no longer usable."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def edit_slack_bookmark(
    ...
    bookmark_link: Annotated[
        str | None,
        "URL of the bookmark to be edited. Ensure it is a valid format starting with http or https.",
    ] = None,
    emoji_tag: Annotated[
        str | None,
        "The emoji tag to apply to the bookmark link. It should be a valid emoji code (e.g., :smile:).",
    ] = None,
...
async def remove_slack_bookmark(
    ...
    slack_channel_id_to_remove_bookmark: Annotated[
        str,
        "The ID of the Slack channel from which the bookmark should be removed. This ID specifies the target channel and is required to locate and delete the bookmark.",
    ],
    bookmark_id_to_remove: Annotated[
        str,
        "The ID of the bookmark to be removed from a Slack channel. Ensure it is specified correctly to delete the correct bookmark.",
    ],
    quip_section_id: Annotated[
        str | None,
        "The ID of the Quip section to unbookmark. This is required to specify which section's bookmark should be removed.",
    ] = None,
...
async def get_slack_bot_info(
    ...
    target_bot_id: Annotated[
        str | None,
        "The unique bot ID for which information is requested. This ID is specific to each workspace the bot is in.",
    ] = None,
    team_id_for_org_token_use: Annotated[
        str | None,
        "Encoded team or enterprise ID where the bot exists. Required if using an organization token. Ignored if using a workspace-level token.",
    ] = None,
...
async def register_slack_call(
    ...
    unique_call_id: Annotated[
        str,
        "A unique ID for the Call, provided by the 3rd-party Call provider. Ensure it is unique across all calls from your service.",
    ],
    ...
    optional_human_readable_display_id: Annotated[
        str | None,
        "An optional, human-readable ID for the call, supplied by the third-party provider. This ID will be displayed in the Call object if given.",
    ] = None,
    ...
    call_title: Annotated[
        str | None,
        "The name of the Call to be registered on Slack. This title will be used to identify the Call within Slack.",
    ] = None,
    call_creator_user_id: Annotated[
        str | None,
        "The valid Slack user ID of the creator of this call. Optional if using a user token, which defaults to the authed user.",
    ] = None,
    participants_info: Annotated[
        list[str] | None,
        "A list of participants to register for the call, including 'slack_id', 'external_id', 'display_name', and 'avatar_url' for each user.",
    ] = None,
...
async def get_call_information(
    ...
    call_id: Annotated[
        str,
        "The unique identifier of the call as returned by the `calls.add` method. This ID is necessary to retrieve detailed call information.",
    ],
...
async def add_call_participants(
    ...
    call_id: Annotated[
        str,
        "The unique identifier for the call, as returned by the `calls.add` method. This ID specifies which call the participants will be added to.",
    ],
    participant_users: Annotated[
        list[str],
        "List of users to add, specified by `slack_id` or `external_id`. Include optional `display_name` and `avatar_url` for each user.",
    ],
...
async def remove_call_participants(
    ...
    call_id: Annotated[
        str,
        "The unique identifier for the call from which participants are to be removed. This `id` is obtained from the `calls.add` method.",
    ],
    users_to_remove: Annotated[
        list[str],
        "A list of user IDs to remove as participants from the call. Refer to Slack's documentation for specifying user IDs.",
    ],
) -> Annotated[dict[str, Any], "Response from the API endpoint 'calls.participants.remove'."]:
    """Remove participants from a Slack call.

    This tool removes specified participants from a call in Slack by registering their removal. Useful when a user needs to manage call attendees."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def delete_scheduled_slack_message(
    ...
    channel_id: Annotated[
        str,
        "The ID of the channel where the scheduled message is set to post. Required to identify the correct message to delete.",
    ],
    scheduled_message_id: Annotated[
        str,
        "The ID of the scheduled message to be deleted. This ID is obtained from the `chat.scheduleMessage` response.",
    ],
    delete_as_authenticated_user: Annotated[
        bool | None,
        "Set to true to delete the message as the authenticated user with `chat:write:user` scope. Bot users are considered authenticated users. If false, the message will be deleted with `chat:write:bot` scope.",
    ] = None,
...
async def get_slack_message_permalink(
    ...
    message_timestamp: Annotated[
        str,
        "The unique timestamp of the message to retrieve the permalink for. It identifies the message within the Slack channel.",
    ],
    ...
    This tool retrieves a permalink URL for an existing message in Slack. Use it when you need the direct link to a particular message in a Slack channel."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def send_ephemeral_message_slack(
    ...
    target_channel: Annotated[
        str,
        "The channel, private group, or IM channel where the ephemeral message will be sent. Accepts an encoded ID or the channel's name.",
    ],
    recipient_user_id: Annotated[
        str,
        "The ID of the user who will receive the ephemeral message. Must be in the specified channel.",
    ],
    structured_attachments: Annotated[
        list[str] | None,
        "A JSON-encoded array of structured attachments for the message. Presented as a URL-encoded string.",
    ] = None,
    structured_blocks: Annotated[
        list[str] | None,
        "A URL-encoded JSON array of structured Slack block elements. Use for rich message formatting.",
    ] = None,
    message_icon_emoji: Annotated[
        str | None,
        "Emoji to display as the message icon, overriding icon_url. Specify using the emoji name like :smile:.",
    ] = None,
    message_icon_url: Annotated[
        str | None,
        "URL for the image to be used as the icon for the message. It overrides the icon_emoji if provided.",
    ] = None,
    message_markdown_text: Annotated[
        str | None,
        "The main text formatted in markdown to be sent as an ephemeral message. Do not use with `blocks` or `text`. Character limit: 12,000.",
    ] = None,
    message_parse_mode: Annotated[
        str | None,
        "Specifies how the message text is interpreted. Options are: 'none', 'full', 'mrkdwn', or 'false'. Defaults to 'none'. (default: 'none')",
    ] = None,
    ephemeral_message_text: Annotated[
        str | None,
        "The main text of the ephemeral message for Slack. It acts as a fallback when using blocks; can be formatted as plain text or markdown. Limit to a few thousand bytes.",
    ] = None,
    parent_message_timestamp: Annotated[
        str | None,
        "The timestamp of the parent message to post this ephemeral message in its thread. Ensure there is already an active thread.",
    ] = None,
    bot_username: Annotated[
        str | None,
        "The username for the bot sending the ephemeral message. This sets the display name in the Slack message.",
    ] = None,
...
async def send_slack_message(
    ...
    target_channel_id_or_name: Annotated[
        str,
        "The encoded ID or name of the channel, private group, or IM where the message will be sent. Retrieve using Slack's conversations.list API.",
    ],
    message_attachments: Annotated[
        list[str] | None,
        'A JSON array of structured attachment objects for the message, provided as a URL-encoded string. Example: `[{"pretext": "pre-hello", "text": "text-world"}]`.',
    ] = None,
    structured_blocks: Annotated[
        list[str] | None,
        "A JSON-based array of structured blocks for constructing messages using Block Kit. Provide as a URL-encoded string. Include fallback text if necessary.",
    ] = None,
    ...
    message_markdown: Annotated[
        str | None,
        "The message text formatted using markdown, up to 12,000 characters. Cannot be used with `blocks` or `text`.",
    ] = None,
    message_metadata: Annotated[
        str | None,
        "A JSON object with 'event_type' and 'event_payload' fields, URL-encoded, providing additional metadata for the message.",
    ] = None,
    parse_mode: Annotated[
        str | None,
        "Specifies how the message content should be treated. Options are 'none' to remove hyperlinks or 'full' to ignore markdown formatting.",
    ] = None,
    message_text: Annotated[
        str | None,
        "The main text of the message. Acts as the primary message or a fallback for notifications when using blocks. Supports plain text or markdown.",
    ] = None,
    thread_timestamp: Annotated[
        str | None,
        "Timestamp of the parent message to which this message will be a reply. Use the parent's `ts` value, not a reply's.",
    ] = None,
    bot_username: Annotated[
    ...
    post_as_authenticated_user: Annotated[
        bool | None,
        "Set to true to post the message as the authenticated user instead of as a bot. Only applicable for classic apps.",
    ] = None,
    ...
    broadcast_reply_to_channel: Annotated[
        bool | None,
        "Set to true to make the reply visible to everyone in the channel when responding to a thread. Use with 'thread_ts'. Default is false.",
    ] = None,
...
async def list_scheduled_messages(
    ...
    pagination_cursor: Annotated[
        str | None,
        "Cursor value for pagination to specify the starting point of the list from a previous call.",
    ] = None,
    latest_timestamp: Annotated[
        str | None,
        "A Unix timestamp marking the latest point in the time range for fetching scheduled messages. Ensure it is greater than the `oldest` timestamp if both are set.",
    ] = None,
    ...
    oldest_timestamp: Annotated[
        str | None,
        "A Unix timestamp representing the start of the time range for scheduled messages. It must be less than the `latest_timestamp` if both are specified.",
    ] = None,
    team_id: Annotated[
        str | None,
        "Encoded team ID to specify which team's channels to list. Required if using an org-level token; ignore for workspace-level tokens.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'chat.scheduledMessages.list'."]:
    """Retrieve scheduled messages from Slack.

    Use this tool to obtain a list of messages that are scheduled to be sent in a Slack workspace. It is useful for managing future communications and staying informed of pending messages."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def schedule_slack_message(
    ...
    slack_channel_id_or_name: Annotated[
        str,
        "Specify the target Slack channel, private group, or DM. Use an encoded ID or the channel name. Retrieve channel ID via `conversations.list`.",
    ],
    schedule_time_unix_timestamp: Annotated[
        int,
        "Unix timestamp for when the message should be posted to Slack. Must be within 120 days and not exceed 30 messages per 5-minute window.",
    ],
    ...
    structured_blocks_json: Annotated[
        str | None,
        "A URL-encoded string of a JSON-based array containing structured blocks for message formatting.",
    ] = None,
    message_markdown: Annotated[
        str | None,
        "Message text in markdown format. Avoid using with 'blocks' or 'text'. Maximum 12,000 characters.",
    ] = None,
    message_parsing_mode: Annotated[
        str | None,
        "Specifies how the message content should be parsed and interpreted when sending to Slack. For more details, refer to chat.postMessage documentation.",
    ] = None,
    message_text: Annotated[
        str | None,
        "The main body of the Slack message or a fallback text when using blocks. Can be plain text or formatted with mrkdwn.",
    ] = None,
    parent_message_timestamp: Annotated[
        str | None,
        "Timestamp of the parent message to which this message is a reply. Use the original message's timestamp, not a reply's timestamp.",
    ] = None,
    metadata_json: Annotated[
        str | None,
        "JSON object containing 'event_type' and 'event_payload' fields. Must be URL-encoded. Note: using this will prevent scheduled messages from posting.",
    ] = None,
    enable_group_linking: Annotated[
        bool | None,
        "Set to true to link user groups in the message. Linking individual users is not supported; use mention syntax instead.",
    ] = None,
    make_reply_visible_to_everyone: Annotated[
        bool | None,
        "Set to true to make the reply visible to everyone in the channel or conversation. Use with `thread_ts`. Defaults to false.",
    ] = None,
...
async def custom_unfurl_slack_urls(
    ...
    channel_id: Annotated[
        str,
        "ID of the Slack channel where the message is posted. Required with 'ts' for custom unfurl or with 'unfurl_id' and 'source'.",
    ],
    message_timestamp: Annotated[
        str,
        "Timestamp of the message to which unfurl behavior will be added. Ensure it corresponds to a message in the specified channel containing a fully-qualified URL registered with your Slack app.",
    ],
    unfurl_url_map: Annotated[
        str,
        "A URL-encoded JSON map with URLs as keys and their corresponding unfurl data as values. Each URL should point to a single attachment, like message buttons.",
    ],
    authentication_invitation_message: Annotated[
        str | None,
        "A simple formatted string sent as an ephemeral message inviting the user to authenticate for full unfurl behavior. Supports Slack's *bold*, _italics_, and linking formatting. If provided, this takes precedence over `authentication_invitation_url`.",
    ] = None,
    custom_authentication_url: Annotated[
        str | None,
        "A URL to redirect users for app authentication to enable full URL unfurling, requires URL encoding.",
    ] = None,
    user_authentication_blocks: Annotated[
        list[str] | None,
        "A URL-encoded JSON array of structured blocks to send as an ephemeral message for user authentication invitation.",
    ] = None,
    ...
    link_source: Annotated[
        str | None,
        "Specify the source of the link to unfurl as either 'composer' for links inside the message composer or 'conversations_history' for links posted to a conversation. Must be used with 'unfurl_id', or alternatively with 'channel' and 'ts'.",
    ] = None,
...
async def accept_slack_invite(
    ...
    channel_name: Annotated[
        str,
        "Provide the desired name for the Slack Connect channel. If the channel doesn't exist in your workspace, this name will be assigned to it.",
    ],
    invite_id: Annotated[
        str | None,
    ...
    slack_channel_id_to_accept: Annotated[
        str | None,
        "The ID of the channel you would like to accept the invitation for. Either this or `invite_id` is required.",
    ] = None,
    workspace_id: Annotated[
        str | None,
        "The ID of the workspace where the channel should be accepted. Required if using an org-level token.",
    ] = None,
...
async def approve_slack_channel_invitation(
    ...
    shared_channel_invite_id: Annotated[
        str,
        "The ID of the shared channel invitation you want to approve. It is required to specifically identify which invitation is being approved for the Slack Connect channel.",
    ],
    other_party_team_id: Annotated[
        str | None,
        "The team or enterprise ID of the other party involved in the Slack Connect invitation you are approving.",
    ] = None,
) -> Annotated[
...
async def create_slack_conversation(
    ...
    channel_name: Annotated[
        str,
        "The name of the new Slack channel to create. It must contain only lowercase letters, numbers, hyphens, and underscores, and be 80 characters or less.",
    ],
    encoded_team_id: Annotated[
        str | None,
        "The encoded team ID where the channel will be created. Required when using an organization-level token. Ignored if using a workspace-level token.",
    ] = None,
...
async def invite_user_to_slack_channel(
    ...
    continue_with_valid_users: Annotated[
        bool | None,
        "Set to true to invite valid users while ignoring invalid IDs when multiple user IDs are provided. Default is false.",
    ] = None,
...
async def join_slack_conversation(
    ...
    This tool is used to join a specified conversation within Slack. It requires appropriate user permissions and should be called when there's a need to participate in an existing Slack channel."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_slack_channels(
    ...
    pagination_cursor: Annotated[
        str | None,
        "The cursor used to paginate through data collections. Use the `next_cursor` from a previous response to continue; omit for the first page.",
    ] = None,
    maximum_number_of_channels: Annotated[
        int | None,
        "Specify the maximum number of channels to return. Must be an integer under 1000. Note that fewer channels than requested may be returned. (default: '100')",
    ] = None,
    team_id_for_org_app: Annotated[
        str | None,
        "Encoded team ID to list channels. Required for org-level tokens; ignored for workspace-level tokens.",
    ] = None,
    channel_types: Annotated[
        str | None,
        "Comma-separated list of channel types to include, e.g., 'public_channel', 'private_channel', 'mpim', 'im'. (default: 'public_channel')",
    ] = None,
    exclude_archived_channels: Annotated[
        bool | None,
        "Set to true to exclude archived channels from the list of Slack channels. Default is false.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'conversations.list'."]:
    """Retrieve a list of all channels in a Slack team.

    This tool retrieves a list of all public and private channels that the user has access to within a Slack team. It can also view direct and multiparty direct messages, depending on the user's permissions."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_shared_channel_invites(
    ...
    workspace_team_id: Annotated[
        str | None,
        "The encoded team ID for the workspace to retrieve invites from. Required when using an organization token.",
    ] = None,
    maximum_invites_to_return: Annotated[
        int | None,
        "Specify the maximum number of unapproved shared channel invites to retrieve. (default: '100')",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
    ...
    This tool retrieves a list of shared channel invites that have been generated or received but are not yet approved by all parties on Slack. It should be called when you need to manage or view pending shared channel invites."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def set_slack_channel_read_cursor(
    ...
    channel_id: Annotated[
        str,
        "The ID of the Slack channel or conversation where you want to set the read cursor. This should be a valid Slack channel ID.",
    ],
    timestamp_of_message_to_mark_as_read: Annotated[
        str,
        "The unique identifier (timestamp) of the message you want to mark as most recently seen in the conversation.",
    ],
) -> Annotated[dict[str, Any], "Response from the API endpoint 'conversations.mark'."]:
    """Update the read cursor in a Slack channel.

    Use this tool to mark a specific point in a Slack channel as read. This is useful for keeping track of the latest read messages in channels, groups, or direct messages. Requires appropriate Slack OAuth scopes."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_slack_conversation_members(
    ...
    conversation_id: Annotated[
        str,
        "The ID of the Slack conversation to retrieve members from. This can be a channel, group, or direct message.",
    ],
    pagination_cursor: Annotated[
        str | None,
        "Cursor for pagination, set to the `next_cursor` value from a previous response to continue retrieving members from a conversation.",
    ] = None,
    max_items_to_return: Annotated[
        int | None,
        "The maximum number of conversation members to return. Recommended to specify a value under 1000, with no more than 200 results at a time for optimal pagination. (default: '100')",
    ] = None,
    ...
    Use this tool to get a list of members in a specific Slack conversation. This can apply to public and private channels, as well as direct and multi-party direct message conversations. Appropriate OAuth scopes are required to access different types of conversations."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def open_or_resume_slack_conversation(
    ...
    conversation_channel_id: Annotated[
        str | None,
        "The ID of an existing direct or multi-person message channel to resume. Alternatively, provide the `users` field to start a new conversation.",
    ] = None,
    target_user_ids: Annotated[
        str | None,
        "A comma-separated list of user IDs to open or resume a conversation. Provide 1 to 8 IDs. Supplying 1 ID opens a 1:1 DM, while more than 1 ID opens a multi-person DM. Do not include the caller's ID.",
    ] = None,
    return_full_im_channel_definition: Annotated[
        bool | None,
        "Set to true to receive the entire IM channel definition; false returns only the conversation ID.",
    ] = None,
    prevent_creation: Annotated[
        bool | None,
        "If true, does not create a new conversation and instead checks for an existing DM or MPDM.",
    ] = None,
    ...
    This tool calls the Slack API to open a new conversation or resume an existing direct message or multi-person direct message. It should be used when there's a need to start or continue a conversation within Slack."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_slack_thread_messages(
    ...
    thread_message_timestamp: Annotated[
        str,
        "Unique identifier of a parent message or a thread message (timestamp). Fetches the thread or the single message.",
    ],
    pagination_cursor: Annotated[
        str | None,
        "Cursor for pagination. Use the `next_cursor` from a previous response to fetch the next page of data.",
    ] = None,
    ...
    maximum_items_to_return: Annotated[
        int | None,
        "Specify the maximum number of messages to fetch. The default and maximum are 15 for certain apps, with possible rate limits. (default: '1000')",
    ] = None,
    ...
    include_boundary_timestamps: Annotated[
        bool | None,
        "Include messages with 'oldest' or 'latest' timestamps. Ignored unless either timestamp is specified.",
    ] = None,
...
async def deny_shared_invite_request(
    ...
    shared_channel_invite_id: Annotated[
        str,
        "The ID for the shared channel invite request that you intend to deny. This is required for specifying which invite to decline.",
    ],
    deny_invite_message: Annotated[
        str | None,
        "An optional message explaining why the invitation was denied. This message will be sent to the requester.",
    ] = None,
) -> Annotated[
...
async def list_custom_emoji_for_team(
    ...
    Use this tool to get a list of custom emojis available for a team on Slack. It should be called when you need to display or manage team-specific emojis."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_external_file_upload_url(
    ...
    file_size_in_bytes: Annotated[
        int,
        "Specify the size of the file to be uploaded, measured in bytes. Ensure this value accurately reflects the file size.",
    ],
    file_name: Annotated[str, "The name of the file to be uploaded to Slack."],
    snippet_syntax_type: Annotated[
        str | None,
        "Specify the syntax highlighting type for the snippet being uploaded, such as 'javascript', 'python', etc.",
    ] = None,
...
async def get_remote_file_info_slack(
    ...
    file_id: Annotated[
        str | None,
        "The unique identifier of the file to retrieve information about. Use this to specify the file in Slack.",
    ] = None,
...
async def get_slack_remote_files_info(
    ...
    filter_by_channel_id: Annotated[
        str | None,
        "Filter remote files to only include those appearing in the specified Slack channel, indicated by its channel ID.",
    ] = None,
    pagination_cursor: Annotated[
        str | None,
        "A cursor for paginating through data. Use the `next_cursor` from a prior request to fetch the next set of results. Defaults to the first page if not set.",
    ] = None,
    maximum_items_to_return: Annotated[
    ...
    filter_files_from_timestamp: Annotated[
        str | None,
        "Filter files created after this inclusive timestamp. Use a Unix timestamp format. (default: '0')",
    ] = None,
    timestamp_filter_end: Annotated[
        str | None,
        "Filter files created before this timestamp (inclusive) in Unix epoch time format. (default: 'now')",
    ] = None,
...
async def share_remote_file_in_channel(
    ...
    target_channel_ids: Annotated[
        str,
        "Comma-separated list of Slack channel IDs where the remote file will be shared. Ensure IDs are valid and the user has permission to share files in these channels.",
    ],
    file_external_identifier: Annotated[
        str | None,
        "The globally unique identifier (GUID) for the file set by the app when registering with Slack. Required if 'file' is not provided.",
    ] = None,
    file_id: Annotated[
        str | None,
        "The ID of a file registered with Slack to be shared. Required if `external_id` is not provided.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'files.remote.share'."]:
    """Share a remote file into a Slack channel.

    This tool shares a specified remote file into a selected Slack channel. It utilizes Slack's API to facilitate file sharing across channels."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def pin_item_to_slack_channel(
    ...
    channel_id: Annotated[
        str,
        "The ID of the Slack channel where the message will be pinned. A `timestamp` must also be provided.",
    ],
    message_timestamp: Annotated[
        str | None,
        "The timestamp (`ts`) of the message to pin in the Slack channel. Ensure the channel is also specified.",
    ] = None,
...
async def list_pinned_items(
    ...
    channel_id: Annotated[
        str,
        "The ID of the Slack channel to retrieve pinned items from. This is required to specify which channel's pinned items will be listed.",
    ],
) -> Annotated[dict[str, Any], "Response from the API endpoint 'pins.list'."]:
    """Retrieve items pinned to a Slack channel.

    This tool calls the Slack API to list all items pinned to a specific channel. It should be used when there is a need to display or manage pinned items in a Slack channel."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def add_slack_reaction(
    ...
    slack_channel_id: Annotated[
        str,
        "ID of the channel where the message is posted. Use to specify the location for adding a reaction.",
    ],
    reaction_emoji_name: Annotated[
        str,
        "The name of the emoji to be used as a reaction. Include skin tone modifiers if applicable (e.g., 'thumbsup::skin-tone-2').",
    ],
    message_timestamp: Annotated[
        str,
        "The timestamp of the message to which the reaction will be added. Ensure the format matches the Slack API requirements.",
    ],
...
async def remove_reaction_from_item(
    ...
    target_file_id: Annotated[
        str | None,
        "The identifier of the file from which to remove the reaction. Specify either this, `target_file_comment_id`, or both `target_channel_id` and `target_message_timestamp`.",
    ] = None,
    file_comment_id: Annotated[
        str | None,
        "The ID of the file comment from which you want to remove the reaction. Provide this if the reaction is on a file comment.",
    ] = None,
    message_channel_id: Annotated[
        str | None,
        "Channel ID where the message to remove the reaction from was posted. Required if removing a reaction from a message. Use in combination with 'message_timestamp'.",
    ] = None,
    message_timestamp: Annotated[
        str | None,
        "The exact timestamp of the message from which to remove the reaction. Specify when targeting a message.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'reactions.remove'."]:
    """Remove a reaction from a Slack item.

    Use this tool to remove a reaction (emoji) from a message, file, or file comment in Slack. This tool is intended for situations where a reaction needs to be revoked. It requires the 'reactions:write' scope, which allows the app to manage reactions on behalf of the user."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def search_files_in_slack(
    ...
    search_query: Annotated[
        str,
        "The text string to search for in Slack files. Use keywords or phrases to narrow down results.",
    ],
    items_per_page: Annotated[
        int | None,
        "The number of file results to return per page. Maximum allowed value is 100. (default: '20')",
    ] = None,
    results_page_number: Annotated[
        int | None,
        "The specific page number of results to retrieve, with a maximum value of 100. (default: '1')",
    ] = None,
    sort_files_by: Annotated[
        str | None,
        "Specify how to sort the search results: either by 'score' or 'timestamp'. (default: 'score')",
    ] = None,
    sort_direction: Annotated[
        str | None,
        "Change the sort direction for search results to ascending ('asc') or descending ('desc'). (default: 'desc')",
    ] = None,
    encoded_team_id: Annotated[
        str | None,
        "Encoded team ID to specify the search domain when using an org-level token. Ignored with a workspace-level token.",
    ] = None,
    ...
    This tool searches for files in Slack that match a given query. It is useful when a user needs to locate specific files shared in Slack channels or direct messages. The tool returns a list of files that meet the search criteria."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def search_slack_messages(
    ...
    results_per_page: Annotated[
        int | None,
        "The number of search results to return per page, with a maximum limit of 100. (default: '20')",
    ] = None,
    ...
    pagination_cursor: Annotated[
        str | None,
        "Use '*' for the first call to start pagination or provide the 'next_cursor' value from previous results to continue.",
    ] = None,
    sort_results_by: Annotated[
        str | None,
        "Specify the criterion for sorting the search results, either by 'score' for relevance or 'timestamp' for chronological order. (default: 'score')",
    ] = None,
    sort_direction: Annotated[
        str | None,
        "Specify the order for sorting results: use 'asc' for ascending or 'desc' for descending. (default: 'desc')",
    ] = None,
    team_id: Annotated[
        str | None,
        "The encoded team ID to search within. Required only if an organization-level token is used. Ignored for workspace-level tokens.",
    ] = None,
    ...
    This tool searches for messages in a Slack workspace that match a specified query. It should be called when users want to find specific messages or discussions within their Slack channels."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_team_billable_users_info(
    ...
    pagination_cursor: Annotated[
        str | None,
        "Cursor for pagination. Use the `next_cursor` from the previous response to fetch the next page of users. (default: 'fetches the first page')",
    ] = None,
    maximum_items_to_return: Annotated[
    ...
    specific_user_id: Annotated[
        str | None,
        "The ID of a specific user to retrieve billable information for. Leave empty to retrieve info for all users.",
    ] = None,
    encoded_team_id: Annotated[
        str | None,
        "Encoded team ID for retrieving billable info, required if using an org token. Ignored with workspace-level tokens.",
    ] = None,
...
async def get_current_slack_team_info(
    ...
    query_by_domain: Annotated[
        str | None,
        "Comma-separated domains to query instead of a team, used when the team is not specified. This only works for domains in the same enterprise as the querying team token.",
    ] = None,
    specific_team_id: Annotated[
        str | None,
        "The ID of the Slack team to retrieve information about. If omitted, information about the current team will be returned.",
    ] = None,
...
async def get_integration_logs(
    ...
    filter_by_app_id: Annotated[
        str | None,
        "Filter integration logs to a specific Slack app. If not provided, logs for all apps are retrieved.",
    ] = None,
    filter_by_change_type: Annotated[
        str | None,
        "Specify the change type to filter logs. Options: 'added', 'removed', 'enabled', 'disabled', 'updated'. Defaults to all logs.",
    ] = None,
    result_count: Annotated[
        str | None,
        "The number of log entries to retrieve. Specify the maximum number of logs to return in a single request. (default: '100')",
    ] = None,
    result_page_number: Annotated[
        str | None,
        "The specific page number of the integration logs to retrieve. Used for pagination. (default: '1')",
    ] = None,
    filter_by_service_id: Annotated[
        str | None,
        "Specify the service ID to filter integration logs related to a specific service. If not provided, logs for all services will be retrieved.",
    ] = None,
    encoded_team_id: Annotated[
        str | None,
        "The encoded team ID to get logs from, required if using an org-level token. Ignored if using a workspace-level token.",
    ] = None,
    filter_by_user: Annotated[
        str | None,
        "Filter logs generated by a specific user's actions. Defaults to all logs if not specified.",
    ] = None,
...
async def get_slack_team_preferences(
    ...
    This tool fetches team preferences from a Slack workspace. It should be called when there's a need to access or review team settings. Requires appropriate OAuth scope for access."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_team_profile(
    ...
    visibility_filter: Annotated[
        str | None,
        "Filter the profile fields based on visibility. Options: 'all', 'visible', 'hidden'. Default is 'all'.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'team.profile.get'."]:
    """Retrieve a team's profile information from Slack.

    This tool retrieves a team's profile from Slack. It should be called when there's a need to access team information such as members, roles, or other relevant details. The tool uses the Slack API and requires the 'users.profile:read' OAuth scope."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def create_slack_user_group(
    ...
    unique_mention_handle: Annotated[
        str | None,
        "A unique mention handle for the user group. It must not duplicate existing handles of channels, users, or other user groups.",
    ] = None,
    ...
    enable_display_as_sidebar_section: Annotated[
        bool | None,
        "Set to true to display the user group as a sidebar section for all group members if the group has one or more default channels.",
    ] = None,
...
async def disable_user_group(
    ...
    team_id: Annotated[
        str | None,
        "Encoded target team ID where the user group exists. Required only if using an org-level token; ignored for workspace-level tokens.",
    ] = None,
    include_user_count: Annotated[
        bool | None,
...
async def enable_slack_user_group(
    ...
    team_id: Annotated[
        str | None,
        "Provide the encoded team ID where the user group is located. Only required if using an org-level token. Ignored with workspace-level tokens.",
    ] = None,
    include_user_count: Annotated[
...
async def list_slack_user_groups(
    ...
    team_id_for_org_token: Annotated[
        str | None,
        "Encoded team ID required when using an org-level token. Ignored if using a workspace-level token.",
    ] = None,
    include_user_count: Annotated[
        bool | None, "Set to true to include the number of users in each User Group."
    ] = None,
    ...
    This tool retrieves a list of all user groups available in a Slack team. It should be called when there's a need to access or display user group information within a Slack workspace."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def update_slack_user_group(
    ...
    default_channel_ids: Annotated[
        list[str] | None,
        "A comma-separated list of channel IDs where the User Group is set as default. Use encoded channel IDs.",
    ] = None,
    ...
    user_group_description: Annotated[
        str | None,
        "A short description of the User Group to update in Slack. This should clearly define the group's purpose or role.",
    ] = None,
    user_group_handle: Annotated[
        str | None,
        "Unique mention handle for the User Group, distinct from all channels, users, and other User Groups.",
    ] = None,
    user_group_name: Annotated[
        str | None,
        "A unique name for the User Group to update. Ensure it does not duplicate any existing User Group names.",
    ] = None,
    team_id_for_org_token: Annotated[
        str | None,
        "Encoded team ID where the user group exists, required for org-level tokens. Ignored if using a workspace-level token.",
    ] = None,
    include_user_count: Annotated[
        bool | None, "Set to true to include the number of users in the User Group."
    ] = None,
    enable_sidebar_section: Annotated[
        bool | None,
        "Set to true to configure the user group to appear as a sidebar section for all group members. Only relevant if the group has 1 or more default channels.",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'usergroups.update'."]:
    """Update an existing User Group in Slack.

    This tool updates an existing User Group in Slack. It should be called when you need to modify the details of a user group, such as its name or permissions. Ensure the appropriate permissions are granted with the 'usergroups:write' scope."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def update_slack_usergroup_users(
    ...
    user_ids_list: Annotated[
        list[str],
        "A comma separated string of encoded Slack user IDs representing the complete user list for the group. This replaces all current members.",
    ],
    team_id_for_org_token: Annotated[
        str | None,
        "Encoded team ID where the user group exists. Required if using an organization token; ignored with workspace-level token.",
    ] = None,
    update_additional_channels: Annotated[
        list[str] | None,
        "Encoded channel IDs to add user group members to, separated by commas. These represent additional channels for custom user group member additions.",
    ] = None,
    include_user_count: Annotated[
    ...
    is_shared_section: Annotated[
        bool | None,
        "Indicates if the API call involves a shared section. Set to true if it does, otherwise false.",
    ] = None,
    ...
    This tool updates the list of users for a specified Slack user group. It should be called when changes to the membership of a Slack user group are required."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_accessible_slack_conversations(
    ...
    pagination_cursor: Annotated[
        str | None,
        "A cursor for pagination to continue listing conversations from a specific point. Use the 'next_cursor' from a previous response. Default is the first page.",
    ] = None,
    maximum_items_to_return: Annotated[
        int | None,
        "The maximum number of conversations to return in the response. Must be an integer with a maximum value of 999. It is recommended to request no more than 200 results at a time for optimal performance. (default: '100')",
    ] = None,
    slack_team_id: Annotated[
        str | None,
        "The encoded ID of the Slack team to list conversations for. Required if using an organization-level token. Ignored if a workspace-level token is used.",
    ] = None,
    channel_types: Annotated[
        str | None,
        "Comma-separated list of channel types to filter conversations. Options: public_channel, private_channel, mpim, im. (default: 'public_channel')",
    ] = None,
    specific_user_id: Annotated[
        str | None,
        "Filter conversations by a specific user ID's membership. Only includes conversations shared with the calling user.",
    ] = None,
    exclude_archived_channels: Annotated[
        bool | None,
        "Set to true to exclude archived channels from the retrieved list of Slack conversations. (default: false)",
    ] = None,
    ...
    This tool calls the Slack API to list all conversations (public channels, private channels, direct messages) that a user has access to. It can be used to view information about different types of conversations including public channels, private channels, and direct or group messages."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_slack_user_presence(
    ...
    target_user_id: Annotated[
        str | None,
        "The Slack user ID for which you want to retrieve presence information. (default: 'authed user')",
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'users.getPresence'."]:
    """Retrieve user presence information from Slack.

    Use this tool to get the presence status of a user on Slack, indicating whether they are active or away."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_user_identity(
    ...
    This tool is used to get detailed information about a user's identity on Slack. It should be called when user identity details are required, such as for authentication purposes or to display user information within an application leveraging Slack's API."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def list_slack_team_users(
    ...
    pagination_cursor: Annotated[
        str | None,
        "Cursor for paginating through data. Use the `next_cursor` from a previous response to continue.",
    ] = None,
    maximum_items_to_return: Annotated[
    ...
    slack_team_id: Annotated[
        str | None,
        "The encoded team ID to list users from, necessary if an organization-level token is used. Ignored if a workspace-level token is provided.",
    ] = None,
    ...
    This tool retrieves a comprehensive list of all users within a specified Slack team. It includes user details and can access email information if the appropriate OAuth scopes are provided."""
    async with httpx.AsyncClient() as client:
        response = await client.request(
...
async def get_slack_user_profile(
    ...
    include_labels: Annotated[
        bool | None,
        "Include labels for each ID in custom profile fields. This option can heavily rate-limit requests and is not recommended. Default is false.",
    ] = None,
...
async def set_slack_profile_photo(
    ...
    crop_box_size: Annotated[
        str | None,
        "The size of the square crop box for the profile photo in pixels. Specify the width and height, which are the same value for a square.",
    ] = None,
    ...
    crop_y_coordinate: Annotated[
        str | None,
        "Y coordinate of the top-left corner of the crop box for the user's profile photo on Slack. This determines where the cropping of the image will start on the vertical axis.",
    ] = None,
    profile_photo_image: Annotated[
        str | None,
        "The image file to set as the Slack profile photo. Provide image data directly with the correct content type (e.g., image/jpeg, image/png).",
    ] = None,
