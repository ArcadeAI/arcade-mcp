...
import arcade_agi
from arcade_agi.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_agi)


@tool_eval()
def agi_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="agi Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to agi tools. "
