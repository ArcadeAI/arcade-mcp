...
catalog = ToolCatalog()
catalog.add_module(complex_tools)


@tool_eval()
def complex_tools_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="complex_tools Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to complex_tools tools. "
