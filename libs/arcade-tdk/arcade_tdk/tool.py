...
def tool(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        func.__tool_annotations__ = annotations  # type: ignore[attr-defined]
        func.__tool_categories__ = categories  # type: ignore[attr-defined]
        func.__tool_tags__ = tags  # type: ignore[attr-defined]
