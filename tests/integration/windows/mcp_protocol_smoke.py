...
Validates real JSON-RPC request/response flows over stdio and HTTP transports
against a server generated by ``arcade new``.  Designed to be invoked from the
Windows CI PowerShell smoke script, but can also be run directly:
