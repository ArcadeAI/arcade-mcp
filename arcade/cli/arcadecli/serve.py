...
import fastapi
import uvicorn
from arcade_tdk_py.core.telemetry import OTELHandler
from arcade_tdk_py.sdk import Toolkit
from arcade_tdk_py.worker.fastapi.worker import FastAPIWorker
...
def _run_mcp_stdio(
    ...
    from arcade_tdk_py.worker.mcp.stdio import StdioServer
...
def serve_default_worker(  # noqa: C901
    ...
    **kwargs: Any,
    ...
    version = get_pkg_version("arcade-tdk-py")
    if mcp:
        validate_and_get_config()
