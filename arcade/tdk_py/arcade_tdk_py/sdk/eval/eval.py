...
from arcade_tdk_py.core.config_model import Config
from arcade_tdk_py.core.schema import TOOL_NAME_SEPARATOR
...
from arcade_tdk_py.sdk.errors import WeightError
from arcade_tdk_py.sdk.eval.critic import NoneCritic

if TYPE_CHECKING:
    from arcade_tdk_py.sdk import ToolCatalog
    from arcade_tdk_py.sdk.eval.critic import Critic
