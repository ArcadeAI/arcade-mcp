...
from arcade_tdk_py.core.catalog import MaterializedTool, ToolCatalog
from arcade_tdk_py.core.executor import ToolExecutor
from arcade_tdk_py.core.schema import ToolAuthorizationContext, ToolContext
from arcade_tdk_py.worker.mcp.convert import convert_to_mcp_content, create_mcp_tool
from arcade_tdk_py.worker.mcp.logging import create_mcp_logging_middleware
from arcade_tdk_py.worker.mcp.message_processor import MCPMessageProcessor, create_message_processor
from arcade_tdk_py.worker.mcp.types import (
    CallToolRequest,
    CallToolResponse,
    CallToolResult,
    CancelRequest,
...
class MCPServer:
    ...
    def _get_user_id(self, init_options: Any) -> str:
        ...
        """
        try:
            from arcade_tdk_py.core.config import config
